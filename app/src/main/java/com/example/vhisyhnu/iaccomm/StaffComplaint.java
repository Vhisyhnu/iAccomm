...
public class StaffComplaint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBlogList=(RecyclerView)findViewById(R.id.gmyrecycleview);
    ...
    protected void onStart(){
        super.onStart();
        FirebaseRecyclerAdapter<cBlog,BlogViewHolder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<cBlog,BlogViewHolder>
                (cBlog.class,R.layout.cblog_row,BlogViewHolder.class,mDatabase) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, cBlog model, int position) {
                ...
                viewHolder.setStudentComplain(model.getStudentComplain());
                viewHolder.setStudentDescription(model.getStudentDescription());
    ...
    public static class BlogViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setStudentComplain(String studentComplain){
            TextView post_comp=(TextView)mView.findViewById(R.id.post_comp);
            post_comp.setText(studentComplain);
        }

        public void setStudentDescription(String studentDescription){
            TextView post_comp=(TextView)mView.findViewById(R.id.post_desc);
            post_comp.setText(studentDescription);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_status2:
                startActivity(new Intent(StaffComplaint.this, Status.class));
                finish();
                break;
            case R.id.nav_settings2:
                startActivity(new Intent(StaffComplaint.this, Settings.class));
                finish();
                break;
            case R.id.logout2:
