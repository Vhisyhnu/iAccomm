...
public class StudentComplaint extends AppCompatActivity {
    ...
    EditText editTextNum, editTextRoom, editTextComplaint;
    ImageView imageView;
    Button buttonAdd, btnUpload, btnChoose;
    Spinner spinnerHostels, spinnerComplaints;
    Uri filepath;
    ...
    DatabaseReference databaseComplain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseComplain = FirebaseDatabase.getInstance().getReference("Complaint");
        ...
        buttonAdd = (Button) findViewById(R.id.buttonAddComplaint);
            ...
            ref.putFile(filepath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(StudentComplaint.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(StudentComplaint.this, "Failed"+e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void addComplain() {
        ...
        String complaint = spinnerComplaints.getSelectedItem().toString();
        String acomplaint = editTextComplaint.getText().toString().trim();


        if (!TextUtils.isEmpty(num)) {
            String id = databaseComplain.push().getKey();
            Complain complain = new Complain(id, num, hostel, room, complaint, acomplaint);

            databaseComplain.child(id).setValue(complain);
