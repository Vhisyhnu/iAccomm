...
public class MonthRecycler extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBlogList = findViewById(R.id.month_id);
    ...
    public void onStart() {
        ...
        final String Month = intent2.getStringExtra("Month");

        FirebaseRecyclerAdapter<StudentDetails, StudentAdapter> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<StudentDetails, MonthRecycler.StudentAdapter>
                (StudentDetails.class,R.layout.month_recycler_view,MonthRecycler.StudentAdapter.class,databaseReference.orderByChild("month").equalTo(Month)) {
            @Override
            protected void populateViewHolder(final MonthRecycler.StudentAdapter viewHolder, final StudentDetails items, int position){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.st_db:
                startActivity(new Intent(MonthRecycler.this, StaffDashboard.class));
                finish();
                break;
            case R.id.st_announ:
                startActivity(new Intent(MonthRecycler.this, StaffAnnouncement.class));
                finish();
                break;
            case R.id.st_logout:
