...
public class InternetSolution3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yesBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(InternetSolution3.this, StudentDashboard.class);
                startActivity(i);
            }
        });
        ...
        noBut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(InternetSolution3.this, StudentComplaint.class);
                startActivity(i);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_home:
                startActivity(new Intent(InternetSolution3.this, StudentDashboard.class));
                finish();
                break;
            case R.id.nav_db:
                startActivity(new Intent(InternetSolution3.this, Dashboard.class));
                finish();
                break;
            case R.id.nav_announcements:
                startActivity(new Intent(InternetSolution3.this, Announcements.class));
                finish();
                break;
            case R.id.nav_change:
                startActivity(new Intent(InternetSolution3.this, ResetPassword.class));
                finish();
                break;
            case R.id.logout:
