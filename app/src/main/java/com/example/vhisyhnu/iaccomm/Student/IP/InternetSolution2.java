...
public class InternetSolution2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_internet_solution2);
        ...
        yesBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(InternetSolution2.this, StudentDashboard.class);
                startActivity(i);
            }
        });
        ...
        noBut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(InternetSolution2.this, StudentComplaint.class);
                startActivity(i);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_home:
                startActivity(new Intent(InternetSolution2.this, StudentDashboard.class));
                finish();
                break;
            case R.id.nav_db:
                startActivity(new Intent(InternetSolution2.this, Dashboard.class));
                finish();
                break;
            case R.id.nav_announcements:
                startActivity(new Intent(InternetSolution2.this, Announcements.class));
                finish();
                break;
            case R.id.nav_change:
                startActivity(new Intent(InternetSolution2.this, ResetPassword.class));
                finish();
                break;
            case R.id.logout:
